# -*- coding: utf-8 -*-
"""Creating AI for generate anime characters using DCGANs and Keras.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Z752p6WlS6cIM2UDBansbL0-30EuyfzI
...
def generate_images(c_values):
  ...
  Args:
    c_values: Sebuah daftar nilai c.

  Returns:
    Sebuah array gambar yang dihasilkan.
  """
...
def generate_images_with_modified_z(n_iterations):
  ...
  for n in range(n_iterations):
    # Modify latent variable for current iteration
    z[:, :, :, 0:20 * n] = -0.5 * n
